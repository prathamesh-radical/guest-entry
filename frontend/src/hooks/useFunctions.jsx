...
export default function useFunctions() {
  ...
  async function handleAddApartment(event, setShowForm) {
    ...
    try {
      ...
      const response = await fetch(
        `${BACKEND_URL}/api/addApartment?user_id=${Number(id)}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function handleUpdateApartment(event, id, onClose) {
    ...
    try {
      ...
      const response = await fetch(
        `${BACKEND_URL}/api/updateApartment?user_id=${Number(userId)}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function handleDeleteApartment(event, id, setShowAlert) {
    ...
    try {
      ...
      const userId = await AsyncStorage.getItem('id');
      const response = await fetch(
        `${BACKEND_URL}/api/deleteApartment?user_id=${Number(userId)}`,
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function handleAddFlat(event, setShowForm) {
    ...
    try {
      ...
      const id = await AsyncStorage.getItem('id');
      const response = await fetch(
        `${BACKEND_URL}/api/addFlat?user_id=${Number(id)}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function handleUpdateFlat(event, id, onClose) {
    ...
    try {
      ...
      const userId = await AsyncStorage.getItem('id');
      const response = await fetch(
        `${BACKEND_URL}/api/updateFlat?user_id=${Number(userId)}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function handleDeleteFlat(event, id, setShowAlert) {
    ...
    try {
      ...
      const userId = await AsyncStorage.getItem('id');
      const response = await fetch(
        `${BACKEND_URL}/api/deleteFlat?user_id=${Number(userId)}`,
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function handleAddVisitor(event, image) {
    event.preventDefault();
    setLoading(true);
    ...
    try {
      ...
      if (image) {
        // send multipart/form-data with the image
        const formData = new FormData();
        // append all visitor fields
        Object.keys(visitorFormData).forEach(key => {
          formData.append(key, visitorFormData[key]);
        });
        ...
        response = await fetch(
          `${BACKEND_URL}/api/addVisitor?user_id=${Number(id)}`,
          {
            method: 'POST',
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  async function handleUpdateVisitor(event, id) {
    ...
    try {
      ...
      const userId = await AsyncStorage.getItem('id');
      const response = await fetch(
        `${BACKEND_URL}/api/updateVisitor?user_id=${Number(userId)}`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function handleDeleteVisitor(event, id, setShowAlert) {
    ...
    try {
      ...
      const userId = await AsyncStorage.getItem('id');
      const response = await fetch(
        `${BACKEND_URL}/api/deleteVisitor?user_id=${Number(userId)}`,
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
