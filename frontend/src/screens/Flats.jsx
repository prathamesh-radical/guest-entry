...
export default function Flat() {
  ...
  const filteredData = sortedData.filter((item, index) => {
    const sno =
      sortDirection.sno === 'ascending'
        ? (index + 1).toString()
        : (sortedData.length - index).toString();
    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <AnimatedScreen>
          ...
          {showForm && <AddFlatModal setShowForm={setShowForm} />}
                ...
                <View
                  ...
                  <View style={styles.cardContent}>
                    ...
                    <Text style={styles.dateText}>
                      Added:{' '}
                      {new Date(item.date).toLocaleDateString('en-GB') || null}
                    </Text>
                  </View>
